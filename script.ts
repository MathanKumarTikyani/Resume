...
const resumeWorkExperience = document.getElementById("resume-work") as HTMLParagraphElement;
const resumeSkills = document.getElementById("resume-skills") as HTMLParagraphElement;
const downloadPdfButton = document.getElementById('download-pdf-btn') as HTMLButtonElement;
const backButton = document.getElementById("back-form-btn") as HTMLButtonElement;
const editButton = document.getElementById("edit-resume-btn") as HTMLButtonElement;
const resumeContent = document.getElementById("preview-content") as HTMLDivElement;
const shareLinkButton = document.getElementById("share-resume-btn") as HTMLButtonElement;
...
function updateFormFromResume() {
    ...
    (document.getElementById("school") as HTMLInputElement).value = education || '';
    (document.getElementById("work-experience") as HTMLTextAreaElement).value = resumeWorkExperience.textContent || '';
