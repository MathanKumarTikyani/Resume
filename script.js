...
const resumeWorkExperience = document.getElementById("resume-work");
const resumeSkills = document.getElementById("resume-skills");
const downloadPdfButton = document.getElementById('download-pdf-btn');
const backButton = document.getElementById("back-form-btn");
const editButton = document.getElementById("edit-resume-btn");
const resumeContent = document.getElementById("preview-content");
const shareLinkButton = document.getElementById("share-resume-btn");
...
form.addEventListener("submit", (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const education = document.getElementById("school").value;
    ...
    (_a = document.querySelector(".wrapper")) === null || _a === void 0 ? void 0 : _a.classList.add("hidden");
...
backButton.addEventListener("click", () => {
    ...
    (_a = document.querySelector(".wrapper")) === null || _a === void 0 ? void 0 : _a.classList.remove("hidden");
...
function updateFormFromResume() {
    ...
    document.getElementById("school").value = education || '';
    document.getElementById("work-experience").value = resumeWorkExperience.textContent || '';
